...
class Init {
	...
	public function theme_config() {
		return array(
			...
			'description'  => esc_html__( 'Install and activate Gutenverse plugin now to be able to use this theme\'s advanced templates. With Gutenverse plugin installed, you gain access to both advance version of templates and block patterns for free which all built using Gutenverse blocks.', 'restance' ),
			...
			'install'      => wp_nonce_url( self_admin_url( 'themes.php?page=restance-dashboard&install-template=gutenverse' ), 'install-template_gutenverse' ),
			'installText'  => get_option( 'restance_gutenverse_template_installed', false ) ? esc_html__( 'Reinstall Advanced Template', 'restance' ) : esc_html__( 'Install Advanced Template', 'restance' ),
			'pages'        => array(
