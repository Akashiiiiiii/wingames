...
class Init {
	...
	public function theme_config() {
		return array(
			...
			'description'  => esc_html__( 'Install and activate Gutenverse plugin now to be able to use this theme\'s advanced templates. With Gutenverse plugin installed, you gain access to both advance version of templates and block patterns for free which all built using Gutenverse blocks.', 'intrace' ),
			...
			'demo'         => esc_html__( 'View Live Demo →', 'intrace' ),
			'demoUrl'      => esc_url( 'https:/gutenverse.com/demo?name=intrace' ),
			'install'      => wp_nonce_url( self_admin_url( 'themes.php?page=intrace-dashboard&install-template=gutenverse' ), 'install-template_gutenverse' ),
			'installText'  => get_option( 'intrace_gutenverse_template_installed', false ) ? esc_html__( 'Reinstall Advanced Template', 'intrace' ) : esc_html__( 'Install Advanced Template', 'intrace' ),
			'pages'        => array(
