...
?>
<section class="section-space <?php echo esc_attr($team_section_class);?> section-bg" style="background-color:#1b1b1b">
    <div class="spiko-team-container container">
        ...
        <div class="section-header">
    <h2 class="section-title mt-5">CONNECT WITH US!</h2>
         <div class="section-separator border-center"></div>
 </div>  
            ...
            <div class="col"> 
                <div class="brands_slider_container"> 
                    <div class="owl-carousel owl-theme"> 
                        <div class="owl-item wp-column">
                          <div class="brands_item d-flex flex-column justify-content-center">
                            <a href="https://www.facebook.com/PhilippineLegitOnlineCasino" target="_blank"><img width="280px" src="/wp-content/uploads/2023/04/big-a-fb.png" alt=""></a>
                          </div>
                        </div> 
                      <div class="owl-item  wp-column ml-2">
                          <div class="brands_item d-flex flex-column justify-content-center ">
                            <a href="https://www.youtube.com/@bigabiga7573/" target="_blank"><img width="280px" src="/wp-content/uploads/2023/04/0-02-06-5e50dfceedbfaa9a7899b07840235b757cb214f88e87824b13fb8b194186804e_892a45aa9163eaad.png" alt=""></a>
                          </div>
                      </div> 
                      <div class="owl-item wp-column ml-2">
                          <div class="brands_item d-flex flex-column justify-content-center">
                           <img width="280px" src="/wp-content/uploads/2023/04/big-a-call.png" alt="">
                          </div>
                      </div> 
