...
?>
<!-- Latest News section -->
<section class="section-space <?php echo esc_attr($spiko_blog_section_class);?> bg-default-color home-blog"style="background-color:#fff">
                ...
                <div class="col-lg-12 col-md-12 col-xs-12">
                    <div class="section-header">
                        ...
                        <?php if ($spiko_home_news_section_title) { ?>
                            <h2 class="section-title mt-5" style="color:black !important"><?php echo esc_html($spiko_home_news_section_title); ?></h2>
